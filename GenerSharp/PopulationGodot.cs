...
{
    /// <summary>
    /// Represents a PopulationGodot of candidate solutions (chromosomes).
    /// </summary>
    public class PopulationGodot : IPopulation
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneticSharp.PopulationGodot"/> class.
        /// </summary>
        /// <param name="minSize">The minimum size (chromosomes).</param>
        /// <param name="maxSize">The maximum size (chromosomes).</param>
        /// <param name="adamChromosome">The original chromosome of all PopulationGodot ;).</param>
        public PopulationGodot(int minSize, int maxSize, IChromosome adamChromosome)
        {
            if (minSize < 2)
            {
                throw new ArgumentOutOfRangeException(nameof(minSize), "The minimum size for a PopulationGodot is 2 chromosomes.");
            }

            if (maxSize < minSize)
            {
                throw new ArgumentOutOfRangeException(nameof(maxSize), "The maximum size for a PopulationGodot should be equal or greater than minimum size.");
            }
        ...
        /// <summary>
        /// Gets or sets the original chromosome of all PopulationGodot.
        /// </summary>
        ...
        public virtual void CreateInitialGeneration()
        {
            ...
            {
                var c = (FloatingPointChromosomeGodot)AdamChromosome.CreateNew();
